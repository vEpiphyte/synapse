        ...
        modl = {
            ...
            'forms': (
                ...
                ('syn:prop', {'doc': 'The base property type.'}, (
                    ...
                    ('universal', {'ptype': 'bool', 'defval': 0,
                                   'doc': 'Specifies if a prop is universal across all nodes types.'}),
                    ('refable', {'ptype': 'bool', 'defval': 0,
                                 'doc': 'This property indicates if the prop may be pivoted to or from using the '
                                        'refs() command'})
                )),
